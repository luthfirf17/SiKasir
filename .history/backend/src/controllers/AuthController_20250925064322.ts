import {   public login = async (req: Request, res: Response): Promise<void> => {
    try {
      console.log('🚀 LOGIN METHOD CALLED - Request received');
...
export class AuthController {
  ...
  public login = async (req: Request, res: Response): Promise<void> => {
    ...
    console.log('Origin header:', req.headers.origin);
      ...
      console.log('🔍 About to query database for user:', loginField);
