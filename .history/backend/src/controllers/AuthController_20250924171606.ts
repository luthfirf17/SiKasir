...
export class AuthController {
  ...
  public logout = async (req: Request, res: Response): Promise<void> => {
    try {
      // For stateless JWT authentication, logout is mainly handled on the client side
      // by removing the token from localStorage. The server doesn't need to do much.
