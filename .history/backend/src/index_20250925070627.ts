...
const startServer = async () => {
  try {
    ...
    // Only create default users if explicitly requested via environment variable
    if (process.env.CREATE_DEFAULT_USERS === 'true') {
      console.log('👥 Creating default users...');
      await createDefaultUsers();
    } else {
      console.log('ℹ️  Skipping default user creation (set CREATE_DEFAULT_USERS=true to enable)');
    }
