            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <div className="flex flex-col justify-center items-center gap-2 mb-6">
                  ...
                  <h1 className="text-3xl lg:text-4xl font-bold text-center bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-lg hover:from-emerald-300 hover:via-blue-300 hover:to-purple-300 transition-all duration-500">
                    SiKasir
                  </h1>
                </div>
      ...
      <>
        ...
        <div className="text-center mb-6">
          <div className="flex flex-col justify-center items-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold text-center bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-lg hover:from-emerald-300 hover:via-blue-300 hover:to-purple-300 transition-all duration-500">
              SiKasir
            </h1>
          </div>
