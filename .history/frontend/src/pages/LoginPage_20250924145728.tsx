...
import { Eye, EyeOff, Building2, ArrowUp, Shield, Zap, DollarSign, BarChart3, Wallet, CreditCard } from 'lucide-react';
  ...
  const FloatingElements = React.memo(() => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-1/4 right-1/4 opacity-10">
        <ArrowUp className="h-16 w-16 text-emerald-400 animate-slide-right" />
      </div>
      ...
      <div className="w-full max-w-md relative">
            ...
            <div className="text-center mb-8">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-gradient-to-r from-blue-500 to-emerald-500 rounded-2xl shadow-lg transform hover:scale-110 transition-transform duration-300">
                  <TrendUp className="h-8 w-8 text-white" />
                </div>
              </div>
        ...
        <div className="mt-6 grid grid-cols-3 gap-4 text-center">
          {[
            ...
            { icon: TrendUp, label: 'Analytics', color: 'text-purple-400' }
