            ...
            <div className="space-y-8">
              <div className="text-center lg:text-left">
                <div className="flex flex-col justify-center items-center gap-2 mb-6">
                  ...
                  <h1 className="text-3xl lg:text-4xl font-black text-center text-white drop-shadow-2xl tracking-wider hover:text-slate-50 transition-all duration-700 relative">
