 ...
 * 
 * Komponen ini menyediakan fungsionalitas manajemen meja restoran yang komprehensif termasuk:
 * - Operasi CRUD pada meja (Create, Read, Update, Delete)
 * - Manajemen status real-time (Available, Occupied, Reserved, Cleaning, Out of Order)
 * - Mode tampilan berganda (Grid, List, Floor Plan)
 * - Pembuatan kode QR untuk pemesanan di meja
 * - Pelacakan riwayat penggunaan dan analitik
 * - Manajemen reservasi dengan detail pelanggan
 * - Organisasi meja berdasarkan area
 * - Filtering dan pencarian tingkat lanjut
 */
